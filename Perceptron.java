...
public class Perceptron
{
    ...
    *                         expected output.
    */
   Perceptron(int numTrials, int inputNodes, int[] hiddenLayerNodes, int outputNodes, String inputFileName)
   {
   ...
   public static void main(String[] args)
   {
      ...
      Perceptron testNetwork = new Perceptron(numberTrials, numberInputActivations, inputarr, numberOutputActivations,
            inputFileFullPath);
